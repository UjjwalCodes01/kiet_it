        ...
        <div className="container position-relative">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-5 mt-4 mt-lg-0">
              <img src="/conclave/session2.png" alt="Digital Conclave 2025 - Session 2" className="img-fluid rounded-4" style={{ boxShadow: "0 20px 60px rgba(0, 0, 0, 0.3)" }} />
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="mb-5">
                ...
                {[
                  ...
                  <div key={speaker.name} className="mb-4 p-4 rounded-4" style={{ background: "#f8fafc", border: "1px solid #e9ecef" }}>
                    ...
                    <p className="mb-0" style={{ fontSize: "1.05rem", lineHeight: 1.7, color: "#444" }}>{speaker.description}</p>
                  </div>
                ))}
              </div>
